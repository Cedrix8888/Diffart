    ...
    return (
        <div>
            ...
            <div className="text-center py-36">
                <p className="font-semibold tracking-tight text-white text-7xl">Make AI image</p>
                <p className="font-semibold tracking-tight text-white text-7xl">more</p>
                <p className="font-semibold tracking-tight text-white text-8xl">customized</p>
